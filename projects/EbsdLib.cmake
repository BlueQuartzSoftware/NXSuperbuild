...
set(EbsdLib_VERSION "1.0.0")
set(EbsdLib_GIT_TAG "v1.0.0")
...
if(APPLE)
  FILE(APPEND ${NX_SDK_FILE} "set(EbsdLib_DIR \"\${NX_SDK_ROOT}/${extProjectName}-${EbsdLib_VERSION}-\${BUILD_TYPE}/share/cmake/${extProjectName}\" CACHE PATH \"\")\n")
elseif(WIN32)
  FILE(APPEND ${NX_SDK_FILE} "set(EbsdLib_DIR \"\${NX_SDK_ROOT}/${extProjectName}-${EbsdLib_VERSION}/share/cmake/${extProjectName}\" CACHE PATH \"\")\n")
else()
  FILE(APPEND ${NX_SDK_FILE} "set(EbsdLib_DIR \"\${NX_SDK_ROOT}/${extProjectName}-${EbsdLib_VERSION}-\${BUILD_TYPE}/share/cmake/${extProjectName}\" CACHE PATH \"\")\n")
endif()
