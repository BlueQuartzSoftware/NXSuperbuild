...
file(APPEND ${NX_SDK_FILE} "set(oneTBB_VERSION \"${oneTBB_VERSION}\" CACHE STRING \"\")\n")
if (CMAKE_GENERATOR MATCHES "Visual Studio")
  file(APPEND ${NX_SDK_FILE} "set(TBB_DIR \"\${NX_SDK_ROOT}/${extProjectName}-\${oneTBB_VERSION}/lib/cmake/TBB\" CACHE PATH \"\")\n")
else()
