...
file(APPEND ${NX_SDK_FILE} "#--------------------------------------------------------------------------------------------------\n")
file(APPEND ${NX_SDK_FILE} "# Python Version ${Python_VERSION}\n")
file(APPEND ${NX_SDK_FILE} "# Python is needed if you want to build the documentation using Mkdocs which will produce\n")
file(APPEND ${NX_SDK_FILE} "# nice looking documentation. If there is no python environment found then DREAM3D will \n")
file(APPEND ${NX_SDK_FILE} "# use the 'discount' library to generate the help files.\n")
if(Python_Interpreter_FOUND AND MKDOCS_FOUND)
  file(APPEND ${NX_SDK_FILE} "# A suitable Python and mkdocs were found.\n")
  file(APPEND ${NX_SDK_FILE} "if(NOT DEFINED DREAM3D_FIRST_CONFIGURE)\n")
